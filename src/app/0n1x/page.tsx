...
const PRIMITIVES = [
  ...
  ["census_proof", "The 650,000+-agent census + Merkle root — recompute it yourself from public shards."],
];
        ...
        <section className="relative overflow-hidden bg-mesh">
          ...
          <div className="relative mx-auto max-w-4xl px-5 py-24 text-center">
            ...
            <p className="mt-6 font-mono text-[12px] text-muted-2">
              650,000+ verified citizens · signed ledger · reality oracle · $0 to verify
            </p>
          </div>
        </section>
...
{`$ python verify_0n1x.py
  ...
  ✓ CENSUS — 650,000+ agents · Merkle root recomputed from public shards
